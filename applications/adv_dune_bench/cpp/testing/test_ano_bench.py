...
def executable(work_dir):
    """Get the path to the adv_dune_bench executable."""
    return os.path.join(work_dir, "adv_dune_bench")
...
def test_multi_if_loopback(
    ...
    in_config_file = os.path.join(work_dir, "adv_dune_bench_default_tx_rx.yaml")
    out_config_file = os.path.join(
        work_dir, "testing", f"adv_dune_bench_{manager}_tx_rx_{packet_size}.yaml"
    )
    update_yaml_file(
        in_config_file,
        out_config_file,
...
def test_multi_rx_q(executable, work_dir, nvidia_nics):
    ...
    # Prepare config
    config_file = os.path.join(work_dir, "adv_dune_bench_default_rx_multi_q.yaml")
    update_yaml_file(
        config_file,
        config_file,
        {
...
def test_hds_rx(executable, work_dir, nvidia_nics):
    ...
    # Prepare config
    config_file = os.path.join(work_dir, "adv_dune_bench_default_tx_rx_hds.yaml")
    update_yaml_file(
        config_file,
        config_file,
        {
...
def test_gpunetio_single_if_loopback(executable, work_dir, nvidia_nics):
    ...
    # Prepare config
    config_file = os.path.join(work_dir, "adv_dune_bench_gpunetio_tx_rx.yaml")
    update_yaml_file(
        config_file,
        config_file,
        {
...
def test_multi_q_hds_tx_rx(executable, work_dir, nvidia_nics):
    ...
    # Prepare config
    config_file = os.path.join(work_dir, "adv_dune_bench_default_tx_rx_multi_q_hds.yaml")
    update_yaml_file(
        config_file,
        config_file,
        {
